...
const articleDefinitions = [
  ...
  ['cap-nhat-ha-tang-khu-cong-nghe-cao-hoa-lac', 'Cập nhật hạ tầng Khu Công nghệ cao Hòa Lạc', 'khoa-hoc-cong-nghe', 'khu-cong-nghe-cao-hoa-lac', 'article-techpark', ['khu-cong-nghe-cao', 'giao-thong'], 'news', false, 2700],
  ...
  ['kinh-nghiem-chon-khu-vuc-song-tai-hoa-lac', 'Kinh nghiệm chọn khu vực sinh sống tại Hòa Lạc', 'doi-song-dan-cu', 'hoa-lac', 'article-life', ['nha-o', 'hoa-lac'], 'guide', true, 3800],
  ['bay-buoc-chuan-bi-truoc-khi-xay-nha', '7 bước chuẩn bị trước khi xây nhà tại Hòa Lạc', 'du-an-dtxd', 'hoa-lac', 'article-construction', ['xay-nha', 'nha-o'], 'guide', true, 5200],
  ['goi-y-lich-trinh-cuoi-tuan-tai-hoa-lac', 'Gợi ý lịch trình cuối tuần tại Hòa Lạc', 'doi-song-dan-cu', 'tien-xuan', 'article-tourism', ['du-lich-cuoi-tuan', 'homestay'], 'guide', false, 2900],
  ['canh-bao-chieu-tro-dang-tin-nha-dat-sai-gia', 'Cảnh báo chiêu trò đăng tin nhà đất sai giá', 'doi-song-dan-cu', 'hoa-lac', 'article-warning', ['canh-bao-lua-dao', 'gia-dat'], 'news', true, 4600],
  ['thi-truong-nha-dat-hoa-lac-nhin-tu-nhu-cau-thuc', 'Thị trường nhà đất Hòa Lạc nhìn từ nhu cầu thực', 'bat-dong-san-hoa-lac', 'hoa-lac', 'property-land', ['gia-dat', 'nha-o'], 'analysis', false, 3400],
  ['huong-dan-thu-tuc-hanh-chinh-co-ban-cho-cu-dan-moi', 'Hướng dẫn thủ tục hành chính cơ bản cho cư dân mới', 'hanh-chinh', 'hoa-lac', 'article-life', ['hoa-lac'], 'guide', false, 1800],
  ...
  ['su-kien-ket-noi-cong-dong-hoa-lac-thang-bay', 'Sự kiện kết nối cộng đồng Hòa Lạc tháng 7', 'doi-song-dan-cu', 'hoa-lac', 'article-life', ['su-kien', 'hoa-lac'], 'news', false, 1500],
  ['so-sanh-chi-phi-xay-nha-mot-va-hai-tang', 'So sánh chi phí xây nhà một tầng và hai tầng', 'du-an-dtxd', 'thach-hoa', 'article-construction', ['xay-nha'], 'analysis', false, 2600],
