...
import contentDraftRoutes from '../modules/contents/contentDraft.routes.js';
...
import adminContentRoutes from '../modules/moderation/adminContent.routes.js';
...
router.use('/drafts', contentDraftRoutes);
