...
function buildGallery(item) {
  ...
  const source = [
    ...
    ...(Array.isArray(item?.mediaIds)
      ? item.mediaIds
      : []),
    ...(Array.isArray(property?.mediaIds)
      ? property.mediaIds
      : []),
    ...(Array.isArray(
      property?.galleryMediaIds,
    )
      ? property.galleryMediaIds
      : []),
  ].filter(Boolean);
...
export default function PropertyDetailPage() {
  ...
  const ownerLabel =
    OWNER_TYPES[property.ownerType] ||
    'Người đăng';
  ...
  const revealPhone =
    useCallback(async () => {
      ...
      try {
        if (
          typeof propertyApi.contact ===
          'function'
        ) {
          await propertyApi.contact(
            item._id,
            'reveal_phone',
          );
        }
        ...
        /*
         * Số điện thoại đã có trong payload.
         * Vẫn hiển thị kể cả khi API ghi nhận
         * lượt liên hệ tạm thời thất bại.
         */
  ...
  return (
    ...
    >
      ...
      <div
        className="property-reading-progress"
        aria-hidden="true"
      >
        <span
          style={{
          ...
          <main className="property-detail-main">
            ...
            <section className="property-description-section">
              <div className="property-section-heading">
                ...
                <div>
                  ...
                  <p>
                    Nội dung chi tiết về bất
                    động sản và điều kiện
                    giao dịch.
                  </p>
                </div>
              </div>
              ...
              {item.summary ? (
                <p className="property-description-lead">
                  {item.summary}
                </p>
              ) : null}
            ...
            <section className="property-safety-notice">
              ...
              <div>
                ...
                <p>
                  Hãy kiểm tra giấy tờ pháp
                  lý, xác minh người đăng,
                  khảo sát thực tế và không
                  chuyển tiền đặt cọc khi
                  chưa có thỏa thuận rõ ràng.
                </p>
              </div>
            </section>

            <section className="property-reaction-section">
              <ReactionBar
                content={item}
              />
            </section>
          ...
          <aside className="property-detail-sidebar">
            <div className="property-detail-sidebar__content">
              ...
              <section className="property-sidebar-card property-sidebar-architecture">
                ...
                <h2>
                  Cần xây dựng trên khu đất
                  này?
                </h2>

                <p>
                  Nhận tư vấn phương án kiến
                  trúc, công năng và dự toán
                  sơ bộ theo nhu cầu thực tế.
                </p>
